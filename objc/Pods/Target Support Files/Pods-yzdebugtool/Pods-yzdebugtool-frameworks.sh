...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/M80TableViewComponent/M80TableViewComponent.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/YZDebugTools/YZDebugTools.framework"
fi
